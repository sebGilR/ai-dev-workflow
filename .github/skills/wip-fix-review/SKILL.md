...
1. Read `review.md`, `execution.md`, and the current diff.
   If Serena is available, use it (`mcp__serena__find_symbol`, `mcp__serena__find_referencing_symbols`)
   to navigate to the symbols that need fixing before editing them.
